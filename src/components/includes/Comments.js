...
export const Comments = (props) => {
    ...
    const arrangeSubComments = (subComments) => {
        return [...subComments].reverse()
    }
        ...
        <Fragment>
            {allComment &&
                orderToTop(allComment).map((comment, index) => {
                    return (
                        <div
                            className={`media comment ${clickedTopicId === comment._id ? 'active' : ''
                                }`}
                            key={index}
                            style={
                        ...
                        >
                            ...
                            <div className="media-body">
                                ...
                                />
                                {comment.subComments &&
                                    arrangeSubComments(comment.subComments).map((reply) => {
                                        return (
